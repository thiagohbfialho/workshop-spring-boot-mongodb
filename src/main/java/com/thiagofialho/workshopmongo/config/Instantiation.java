...
public class Instantiation implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		Post post1 = new Post(null, sdf.parse("21/03/2018"), "Take off travel", "I'll travel to São Paulo!",maria);
		Post post2 = new Post(null, sdf.parse("23/03/2018"), "Good morning", "I wake up happy today!",maria);
